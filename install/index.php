                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group text-center">
                                               <a href="#" class="btn btn-success btn-custom">Posted by GanjaParker</a>
                                            </div>

                                            <div class="form-group">
                                                <label for="email">License Code</label>
                                                <textarea name="license_code" class="form-control form-input" style="resize: vertical; height: 100px;line-height: 24px;padding: 10px;" placeholder="Enter anything, it`s nulled release!" required><?php echo @$_SESSION["license_code"]; ?></textarea>
                                            </div>
