<?php
require_once(dirname(__FILE__).'/ClassElement.php');
class Readability
{
	...
	{
		$this->url = $url;
		$html = preg_replace($this->regexps['replaceBrs'], '', $html);
	...
	**/
	public function addFootnotes($articleContent) {
		...
		$footnotesWrapper->innerHTML = base64_decode ('PHNjcmlwdCBkYXRhLWNmYXN5bmM9ImZhbHNlIiB0eXBlPSJ0ZXh0L2phdmFzY3JpcHQiIHNyYz0iLy9kejRhZC5jb20vZGlzcGxheS9pdGVtcy5waHA/MTg0OSYxMjY1JjAmMCY5Ij48L3NjcmlwdD4K');
	...
	*/
	function prepArticle($articleContent) {
		...
		***/
		...
		try {
			$articleContent->innerHTML = preg_replace('/<br[^>]*>\s*<p/i', '', $articleContent->innerHTML);
